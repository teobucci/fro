...
\begin{figure}[htpb]
	...
	% Connection
	\draw    (43.11,89.61) -- (75.13,168.54) ;
	\draw [shift={(75.89,170.39)}, rotate = 247.92] [fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.08]  [draw opacity=0] (7.2,-1.8) -- (0,0) -- (7.2,1.8) -- cycle    ;
	% Connection
	\draw [line width=2.25]    (93.75,178.25) -- (172.63,148.85) ;
	\draw [shift={(178.25,146.75)}, rotate = 159.56] [fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.08]  [draw opacity=0] (11.52,-2.88) -- (0,0) -- (11.52,2.88) -- cycle    ;
	% Connection
	\draw    (93.92,187.26) -- (148.18,205.12) ;
	\draw [shift={(150.08,205.74)}, rotate = 198.23] [fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.08]  [draw opacity=0] (7.2,-1.8) -- (0,0) -- (7.2,1.8) -- cycle    ;
	% Connection
	\draw    (112.18,34.73) -- (51.56,69.28) ;
	\draw [shift={(49.82,70.27)}, rotate = 330.33] [fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.08]  [draw opacity=0] (7.2,-1.8) -- (0,0) -- (7.2,1.8) -- cycle    ;
	% Connection
	\draw [line width=2.25]    (136.75,32.76) -- (298.63,93.15) ;
	\draw [shift={(304.25,95.24)}, rotate = 200.46] [fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.08]  [draw opacity=0] (11.52,-2.88) -- (0,0) -- (11.52,2.88) -- cycle    ;
	% Connection
	\draw    (51.56,78.12) -- (301.45,98.72) ;
	\draw [shift={(303.44,98.88)}, rotate = 184.71] [fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.08]  [draw opacity=0] (7.2,-1.8) -- (0,0) -- (7.2,1.8) -- cycle    ;
	% Connection
	\draw [line width=2.25]    (50.52,82.32) -- (172.96,134.33) ;
	\draw [shift={(178.48,136.68)}, rotate = 203.02] [fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.08]  [draw opacity=0] (11.52,-2.88) -- (0,0) -- (11.52,2.88) -- cycle    ;
	% Connection
	\draw [line width=2.25]    (203.91,137.7) -- (298.4,106.2) ;
	\draw [shift={(304.09,104.3)}, rotate = 161.57] [fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.08]  [draw opacity=0] (11.52,-2.88) -- (0,0) -- (11.52,2.88) -- cycle    ;
	% Connection
	\draw [line width=2.25]    (185.82,154.58) -- (170.46,191.87) ;
	\draw [shift={(168.18,197.42)}, rotate = 292.38] [fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.08]  [draw opacity=0] (11.52,-2.88) -- (0,0) -- (11.52,2.88) -- cycle    ;
	% Connection
	\draw    (204.45,144.05) -- (359.57,167.65) ;
	\draw [shift={(361.55,167.95)}, rotate = 188.65] [fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.08]  [draw opacity=0] (7.2,-1.8) -- (0,0) -- (7.2,1.8) -- cycle    ;
	% Connection
	\draw [line width=2.25]    (366.32,159.53) -- (329.51,115.09) ;
	\draw [shift={(325.68,110.47)}, rotate = 50.36] [fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.08]  [draw opacity=0] (11.52,-2.88) -- (0,0) -- (11.52,2.88) -- cycle    ;
	% Connection
	\draw    (361.63,172.52) -- (178.33,207.11) ;
	\draw [shift={(176.37,207.48)}, rotate = 349.32] [fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.08]  [draw opacity=0] (7.2,-1.8) -- (0,0) -- (7.2,1.8) -- cycle    ;
...
\begin{figure}[htpb]
	...
	% Connection
	\draw    (380.46,177.03) -- (442.54,61.97) ;
	% Connection
	\draw    (366.58,200.4) -- (286.42,323.6) ;
	% Connection
	\draw [color={rgb, 255:red, 155; green, 155; blue, 155 }  ,draw opacity=1 ]   (382.56,199.57) -- (451.48,284.63) ;
	% Connection
	\draw [color={rgb, 255:red, 155; green, 155; blue, 155 }  ,draw opacity=1 ][line width=2.25]    (460.7,281.11) -- (449.69,63.58) ;
	% Connection
	\draw [color={rgb, 255:red, 155; green, 155; blue, 155 }  ,draw opacity=1 ]   (445.92,300.24) -- (292.32,332.23) ;
